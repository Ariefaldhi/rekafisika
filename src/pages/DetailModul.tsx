      ...
      <header className="sticky top-0 z-[60] bg-white/80 backdrop-blur-md border-b border-slate-100 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-2xl text-xs font-black transition-all shadow-sm ${showLKPD ? 'bg-slate-900 text-white shadow-slate-500/20' : 'bg-orange-50 border border-orange-100 text-orange-600 hover:bg-orange-100'
              }`}
          >
